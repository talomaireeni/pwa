/*
This class is for InboxRichEditor form element. It is used to create a new InboxRichEditor form element and validate it.
Quill.js script is used to create the InboxRichEditor form element and it should be already included in the page.
...
import { generateUUID } from '../../../studio/js/app/models/utilities.js'; // TODO: move this to a shared location

class InboxRichEditor {
    /**
     * Create a new InboxRichEditor form element.
    ...
    /**
     * Initialize the InboxRichEditor form element.
     */
    initialize() {

        // if  QUILL_IS_READY is already set up, exit
        if (InboxRichEditor.QUILL_IS_READY) {
            return;
        }
        else {
            ...
            InboxRichEditor.QUILL_IS_READY = true;
        }
    }

    /**
     * Render the InboxRichEditor form element.
     */
    render() {
        ...
        <div id="hudhud-rich-editor-${this.editorId}" class="editor-wrapper node-form-element">
            ...
            <div id="editor-${this.editorId}" class="editor-text">
    ...
    /**
     * Activate the InboxRichEditor form element.
     */
    ...
    activateEditor() {
        ...
        InboxRichEditor.definedEditors[this.editorId] = this.quill;
        return this.quill;
    }

    /**
     * Enable the variables for the InboxRichEditor form element.
     */
    ...
    /**
     * Enable the emoji for the InboxRichEditor form element.
     */
    ...
    enableEmoji() {
        ...
        if (this.showEmoji) {
            ...
            $('emoji-picker')
                .off('emoji-click')
                .on('emoji-click', (e) => {
                    console.log('emoji-click', e);
                    InboxRichEditor.activeEditor.insertText(InboxRichEditor.activeEditor.getSelection()?.index || 0, e.detail.unicode);
                });
            ...
            this.editorContainer.find('.picker-btn')
                ...
                .on('click', (e) => {
                    ...
                    $('emoji-picker').css({ "position": "absolute", "top": e.pageY - $('emoji-picker').height(), "left": e.pageX }).show();

                    InboxRichEditor.activeEditor = InboxRichEditor.definedEditors[$(e.target).data('editor-id')];
                    ...
                    $('html').click((e) => {
                        if (!$(e.target).hasClass('picker-btn') && !$(e.target).hasClass('emoji-picker') && $(e.target).prop('tagName').toLowerCase() !== 'emoji-picker') {
                            ...
                            $('emoji-picker').hide();
                            InboxRichEditor.activeEditor = null;
                            $('html').off('click');
                        }
                    });
                });
    ...
    /**
     * Get the text of the InboxRichEditor form element.
    ...
    /**
     * Generate snippet of the InboxRichEditor form element.
    ...
    /**
     * Export the InboxRichEditor form element.
    ...
    /**
     * Import the InboxRichEditor form element.
    ...
    /**
     * Validate the InboxRichEditor form element.
...
export default InboxRichEditor;